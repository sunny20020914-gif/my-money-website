  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-background">
        ...
        <main>
          <HeroSection />
          {/* 【並び順の理由】以前はヒーローの直後に SiteGuide（目的から探す）を
              置いていたが、15枚のカードがランキングを画面のはるか下へ押し下げていた。
              トップに来た人がまず見たいのは「どの企業の初任給が高いのか」という
              中身であって、サイトの案内図ではない。
              実データを先に見せ、案内図は読み終えた人向けに下へ回す。 */}
          <RankingPreview />
          <DynamicAdBanner />
          <ArticlePreview />
          {/* 【クロール導線】主要な一覧ページ全てへ本文中からリンクする。
              ...
              ページ下部でもフッターより上の本文内であり、この効果は変わらない。 */}
          <SiteGuide />
